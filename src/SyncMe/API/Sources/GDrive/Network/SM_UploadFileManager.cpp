...
void SM_UploadFileManager::slotUploadFinished()
{
...
void SM_UploadFileManager::setUploadSettings(void)
{
...
void SM_UploadFileManager::postFinishedActions(QNetworkReply* reply)
{
...
void SM_UploadFileManager::slotUploadProgress( qint64 bytesSent, qint64 bytesTotal )
{
    progressBarDialog.setMaximum(bytesTotal);
    progressBarDialog.setValue(bytesSent);
}

void SM_UploadFileManager::startUpload(QUrl url, const QString &fileName)
{
    setProgressBarSettings(fileName, fileName);
    postRequest(url);
}

void SM_UploadFileManager::setProgressBarSettings(const QString &fileName, const QString &progressBarDialogInfoText)
{
    Q_UNUSED(progressBarDialogInfoText);

    SM_NetworkManager::setProgressBarSettings(fileName, tr("Subiendo fichero: "));
    setUploadSettings();
}

QString SM_UploadFileManager::getContentTypeByExtension(const QString &ext)
{
    QString contentType;
