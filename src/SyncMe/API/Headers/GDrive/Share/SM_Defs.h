...
#define SYNCME_APP_ID QString("861466322111-54tn24tg5qrdifk51ej7is71jok2tb3i.apps.googleusercontent.com")
#define SYNCME_SECRET_ID QString("IRnml2iuovC-3eAWci0Z75Y5")
#define SYNCME_URI QString("http://adrianbzg.github.io/SyncMe/oauthcallback.html")
#define SYNCME_SCOPES QString("https://www.googleapis.com/auth/drive+https://www.googleapis.com/auth/drive.file+https://www.googleapis.com/auth/userinfo.email")

#define GET_FULL_ROOT_CONTENT QString("https://www.googleapis.com/drive/v2/files/root/children")
#define GET_FILES_IN_FOLDER QString("https://www.googleapis.com/drive/v2/files/root")
#define ROOT_TAG QString("https://www.googleapis.com/drive/v2/files")
